...
// assigned the value of 'Dane' to the variable 'name'
// wrote a conditional code that if name equals Mary then console 'Hi, Mary!'
// if name does not equal to Mary then console log 'How do you do?'
// console log appears 'How do you do?'
...
// created a variable named code and assigned a value of 123 to it 
// code equals to 123 then secret's value becomes super and code's value is multiplied by 2 which becomes 246
//code's value is less than 250 and in turn secret's value is now 'duper'
// the console log display's secret's value as 'duper'
